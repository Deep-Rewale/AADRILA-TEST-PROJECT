...
function Industries() {
  return (
    <div className="relative py-32 px-20 overflow-hidden max-lg:px-10 max-sm:py-20 max-md:px-6">
      {/* Main Grid */}
      <div className="grid grid-cols-2 gap-20 max-lg:grid-cols-1">
        {/* left content  */}
        <div className="left-text z-4">
          <p
            className="font-manrope font-bold text-3xl/[68.25px] inline-block bg-[linear-gradient(110deg,#CD6028_0%,#CD6028_45%,#3E6EB4_130%)]  
       bg-clip-text text-transparent max-md:text-2xl max-sm:text-xl"
          >
            AI-driven innovation for growth.
          </p>
          <h2 className="font-raleway font-semibold text-5xl max-md:text-4xl max-sm:text-3xl ">
          ...
          >
            ...
            <div className="card1 absolute left-70 bottom-35 w-90 rounded-2xl py-20 px-13 shadow-2xl bg-white max-lg:static max-lg:mx-auto max-lg:w-[22rem] max-md:w-full max-2xl:left-20">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                />
                <h3 className="font-raleway font-bold text-dark text-2xl">
                  Insurance
                </h3>
                <p className="font-manrope text-[#696969] text-base font-medium">
