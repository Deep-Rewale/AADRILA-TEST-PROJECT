...
function Hero() {
  return (
    // Hero section
    <div
      className="relative w-full h-screen bg-cover bg-center max-lg:h-auto"
    ...
    >
      ...
      <div className="hero-content relative py-66 px-20 z-20 flex justify-around max-lg:flex-col-reverse max-lg:py-40 max-lg:gap-20 max-md:gap-12 max-lg:px-8 ">
        ...
        <div className="textStructure  w-3xl max-md:w-full">
          <h1
            className="font-raleway font-bold text-5xl/[68.25px] inline-block bg-[linear-gradient(110deg,#CD6028_0%,#CD6028_45%,#3E6EB4_130%)]  
       bg-clip-text text-transparent max-md:text-4xl max-sm:text-3xl"
          >
            AI-Powered
          </h1>
          <h1 className="font-raleway font-bold text-5xl/[68.25px] text-dark max-md:text-4xl max-sm:text-3xl">
            Document Automation
          </h1>
          <h1 className="font-raleway font-bold text-5xl/[68.25px] text-dark max-md:text-4xl max-sm:text-3xl">
            & Fraud Detection
          </h1>
          <p className="max-w-120 mt-5 font-manrope text-xl/8 font-medium max-md:text-lg max-sm:text-base">
